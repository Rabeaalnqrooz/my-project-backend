...
const allowedOrigins = [
  "http://localhost:5173", // لوكال فايت للـتطوير
  "https://my-project-frontend-git-main-rabea1.vercel.app", // رابط الفيرسل الحالي بدقة وبدون شرطة مائلة بنهايته
];

app.use(
  cors({
    origin: function (origin, callback) {
      // السماح بالطلبات التي لا تحتوي على origin (مثل أدوات الفحص Postman أو الأجهزة المحلية)
    ...
    credentials: true, // مصيري جداً للسماح بتبادل الـ Cookies أونلاين
